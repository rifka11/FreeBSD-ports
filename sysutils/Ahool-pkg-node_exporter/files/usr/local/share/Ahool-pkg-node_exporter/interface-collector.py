...
metrics = {
	'up': simplemetric('node_ahool_interface_up','1 if interface is enabled, else 0.'),
	'info': simplemetric('node_ahool_interface_info', 'Information about the interface. Always 1.')
}
...
textfile = open('/var/tmp/node_exporter/ahool.prom','w')
