			...
			<table class="table table-hover">
				<tr>
					<td>Use this to tool to backup files and directories. The following directories are recommended for backup:
						<table>
							<tr><td><strong>Ahool Config:</strong></td><td>/cf/conf</td></tr>
	...
	<div class="panel-body">
		<div class="table-responsive">
			...
			<table class="table table-hover">
				<tr>
					<td>
					The 'Backup' button compresses the directories that are listed below to /root/backup/ahool.bak.tgz; after that it presents the file for download.<br />
					If the backup file does not exist in /root/backup/ahool.bak.tgz then the 'Restore' and 'Delete' buttons will be hidden.
					</td>
				</tr>
				<tr>
					<td>
