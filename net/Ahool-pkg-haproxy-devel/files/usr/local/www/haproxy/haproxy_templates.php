	...
	<div class="panel panel-default">
		...
		<div class="table-responsive panel-body">
			...
			<div class="col-sm-8">
				...
				<br/>
				After applying the changes made by the template use this link to visit the stats page: <a target="_blank" href="https://<?=get_interface_ip("lan");?>:444">https://Ahool-LAN-ip:444/</a>
			</div>
		</div>
		<br/>
	</div>
