...
/* Compatibility function for Ahool 2.0 */
...
$section->addInput(new Form_StaticText(
	...
	Certificates can be imported into the <a href="/system_camanager.php" target="_blank">Ahool "Certificate Authority Manager"</a>
