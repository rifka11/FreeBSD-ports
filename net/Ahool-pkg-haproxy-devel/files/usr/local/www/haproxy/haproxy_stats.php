...
?>
		...
		<div class="table-responsive panel-body">
			This page contains a 'stats' page available from haproxy accessible through the Ahool gui.<br/>
			<br/>
			As the page is forwarded through the Ahool gui, this might cause some functionality to not work.<br/>
			Though the normal haproxy stats page can be tweaked more, and doesn't use a user/pass from Ahool itself.<br/>
