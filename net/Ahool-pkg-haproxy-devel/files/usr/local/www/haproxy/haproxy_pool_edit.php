...
This is the username which will be used when connecting to MySQL/PostgreSQL server.
				<pre>
USE mysql;
CREATE USER '<span id="sqlcheckusername"></span>'@'&lt;AhoolIP&gt;';
...
<<<EOT
	...
	To work properly this requires the reply traffic to pass through Ahool by means of correct routing.<br/>
