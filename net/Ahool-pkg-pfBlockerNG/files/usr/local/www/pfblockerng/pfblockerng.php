...
require_once('/usr/local/pkg/pfblockerng/pfblockerng_extra.inc');	// 'include functions' not yet merged into Ahool
...
function pfb_update_check($header, $list_url, $pfbfolder, $pfborig, $pflex, $format, $vtype) {
	...
	if (file_exists($local_file)) {
		...
		// Determine if URL is a Ahool localfile
		$localfile = FALSE;
...
$section->addInput(new Form_StaticText(
	...
	. 'Ahool by default implicitly blocks all unsolicited inbound traffic to the WAN interface.<br />'
