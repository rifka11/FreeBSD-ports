...
$section->addInput(new Form_Checkbox(
	'publishing',
	'Enable publishing',
	'Enable publishing of information about the Ahool host',
	$pconfig['publishing']
))->setHelp(
	'Use with caution. Publishing can reveal a good deal of information about your Ahool host.%sNote that this option enables publishing of default system services such as ssh and ftp-ssh.', '<br/>'
);
...
$group->add(new Form_Checkbox(
	'publish_addresses',
	'Publish addresses',
	'Publish address records for the Ahool host',
...
$group->add(new Form_Checkbox(
	'publish_hinfo',
	'Publish host info',
	'Publish a host information record (OS and CPU info) for the Ahool host',
...
$group->add(new Form_Checkbox(
	'publish_workstation',
	'Publish workstation',
	'Publish a workstation record for the Ahool host',
...
$group->add(new Form_Checkbox(
	'publish_domain',
	'Publish Domain',
	'Publish the domain name in use by the Ahool host',
