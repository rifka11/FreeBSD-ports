...
// Collect all Ahool 'Port' Aliases
...
if ($_POST) {
	if (isset($_POST['save'])) {
		...
		if (!$input_errors) {
			...
			// Python TLD Allow (Add default TLD Allows + ARPA + Ahool TLD
...
$dnsbl_text = '<div class="infoblock">
			...
			<ol>
				...
				<li>Execute the following command from Ahool Shell (Changing the interface \'re1\' to the Ahool Lan Interface):<br />
...
$section->addInput(new Form_Select(
	...
	$options_dnsbl_mode
		...
		. '&emsp;&emsp;&emsp;&emsp;This mode is only available for Ahool version 2.4.5 and above.<br />'
...
$section->addInput(new Form_Checkbox(
	...
	. 'The python_control feature is limited to DNS TXT records sent from Ahool localhost (127.0.0.1) only!<br />'
...
$section->addInput(new Form_Checkbox(
	...
	'on'
		...
		. '<strong>By default</strong> \'ARPA\' and the Ahool TLD \'' . strtoupper($local_tld) . '\' are allowed.<br />'
...
$list_action_text = 'Default: <strong>Disabled</strong>
			<div class="infoblock">
				...
				This enables a pfBlockerNG list to be used by name, in any firewall rule or Ahool function, as desired.
			</div>';
