...
// Grab Ahool version so we can refer to it later on this page
		...
		<table class="table table-striped table-hover table-condensed sortable-theme-bootstrap" data-sortable>
			...
			if (!empty($blocked_ips_array)) {
				...
				foreach($src_ip_list as $blocked_ip => $blocked_msg) {
					...
					/* Add reverse DNS lookup icons (two different links if Ahool version supports them) */
					$rdns_link = "";
...
<!-- file in Ahool.  See copyright info at top of this page.          -->
