...
elseif (isset($id) && !isset($a_rule[$id])) {
	...
	// Walk Ahool-configured interfaces, and take first one not already in our Suricata list
	foreach ($ifaces as $i) {
...
$section->addInput(new Form_Input(
	...
	'text',
	$pconfig['descr']
))->setHelp('Enter a meaningful description here for your reference. The default is the Ahool interface friendly description.');
